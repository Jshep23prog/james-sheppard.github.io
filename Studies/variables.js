 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * 
 * 0. Variables are named containers for data in JavaScript. Variables can point to values of a particular type, 
 * like a String, Number, Boolean, Array, Object or other data types. These are called Variables because once
 * created, we can CHANGE the value (and type of value) to which they point.
 * 
...
//***********************************************************************************/
/**
 * Let us begin with a data table that can help clarify the difference between var, let and const
 *                              var                 let                 const
 * reassignable                 yes                 yes                 no
 * hoisted                      yes                 no                  no
 * scoped globally              yes                 no                  no
 * scoped to functions          yes                 yes                 yes
 * scoped to if blocks          no                  yes                 yes
 * scoped to loop blocks        no                  yes                 yes
 */
//***********************************************************************************/
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~var~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//***********************************************************************************/

//  * Before the introduction of ES6, var declarations were ubiquitous. There are issues associated with variables declared with var though.
//  * That's why it was necessary for new ways to declare variables to emerge.
//  * 
//  * Scope esentially means where these variables are available for use. var declarations are globally scoped or function/locally scoped.
//  * 
//  * The scope is global when declared outside of a function. This means that any variable declared with var outside a function block is
...
// A block is a chunk of code bound by {}. A block lives in curly braces. Anything within curly braces is a block.
