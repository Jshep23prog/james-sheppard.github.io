...
function toLowerCase(string) {
    ...
    //return a new string forced to lowercase by using toLowerCase()
...
function toUpperCase(string) {
    ...
    //return a new string forced to uppercase by using toUpperCase()
...
/*
I string
O lowercase all letters and convert space to dash
C use toLowerCase and replace to convert'' to '-'
E
*/
